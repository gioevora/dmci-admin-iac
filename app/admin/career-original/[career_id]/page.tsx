...
import ApplicationTable from './applicationtb';
    ...
    return (
        <div className="container">
            ...
            <ol className="flex items-center whitespace-nowrap">
                ...
                <Link href="/admin/career" className="inline-flex items-center text-sm text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600" aria-current="page">
                    Career
                    <svg className="shrink-0 mx-2 size-4 text-gray-400 dark:text-neutral-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="m9 18 6-6-6-6"></path>
                    </svg>
                </Link>
                <li className="cursor-default inline-flex items-center text-sm font-semibold text-black truncate" aria-current="page">
                    Application
                </li>
            </ol>
            <div className="flex flex-col bg-white border border-gray-200 shadow-sm rounded-xl md:p-5 mt-8">
                <ApplicationTable career_id={career_id} />
            </div>
        </div>
    );
}