        ...
        { label: 'Name', accessor: (category: Category) => category.name },
        {
            ...
            accessor: (category: Category) => (
                <video
                    ...
                    poster={`https://dmci-agent-bakit.s3.ap-southeast-1.amazonaws.com/videos/${category.thumbnail}`}
                >
                    <source
                        src={`https://dmci-agent-bakit.s3.ap-southeast-1.amazonaws.com/videos/${category.video}?t=${Date.now()}`}
                        type="video/mp4"
                    />
