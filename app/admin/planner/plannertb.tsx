        ...
        { label: "Width", accessor: (category: Category) => category.width },
        {
            ...
            accessor: (category: Category) => (
                <Gallery withDownloadButton>
                    <Item original={`https://dmci-agent-bakit.s3.ap-southeast-1.amazonaws.com/items/${category.image}`} height="500" width="500">
                        {({ ref, open }) => (
                            <img
                                ref={ref}
                                onClick={open}
                                src={`https://dmci-agent-bakit.s3.ap-southeast-1.amazonaws.com/items/${category.image}`}
                                alt="Resume"
                ...
                // <a
                //     href={`https://dmci-agent-bakit.s3.ap-southeast-1.amazonaws.com/items/${category.image}`}
                //     download={`Item_${category.image}`}
