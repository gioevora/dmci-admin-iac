...
const Table: React.FC = () => {
    ...
    const filteredCategories = categories.filter((category) =>
        category.first_name && category.first_name.toLowerCase().includes(searchTerm.toLowerCase()) || category.last_name && category.last_name.toLowerCase().includes(searchTerm.toLowerCase())
    );
    ...
    const columns = [
        ...
        { label: 'First Name', accessor: (category: Category) => category.first_name },
        { label: 'Last Name', accessor: (category: Category) => category.last_name },
        { label: 'Email', accessor: (category: Category) => category.email },
        { label: 'Phone', accessor: (category: Category) => category.phone },
        { label: 'Property Name', accessor: (category: Category) => category.property_name },
        { label: 'Property Location', accessor: (category: Category) => category.property_location },
        { label: 'Unit Type', accessor: (category: Category) => category.unit_type },
        {
            label: 'Actions',
