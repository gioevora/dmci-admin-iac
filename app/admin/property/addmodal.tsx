...
const AddProperty: React.FC<AddPropertyProps> = ({ mutate }) => {
    ...
    const handleAddSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/properties`, data, { headers });
            if (response?.data) {
                setFormData({
                    name: '',
                    logo: '',
                ...
                // Send email notification after adding property
                await axios.post(`/api/email/property/submit`, {
                            ...
                            <div className="p-4 overflow-y-auto">
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    <div className="col-span-2">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Property Name</label>
                                    ...
                                    <div className="col-span-2">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Property Status</label>
                                    ...
                                    <div className="col-span-3">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Property Location</label>
                                        <input
                                            type="text"
                                            name="location"
                                            className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    ...
                                    <div className="col-span-1">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Property Progress(%)</label>
                                        <input
                                            type="number"
                                            name="percent"
                                            className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    ...
                                    <div className="col-span-2">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Minimum Price</label>
                                        <input
                                            type="number"
                                            name="min_price"
                                            className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    ...
                                    <div className="col-span-2">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Maximum Price</label>
                                        <input
                                            type="number"
                                            name="max_price"
                                            className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    ...
                                    <div className="col-span-4">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Property Slogan</label>
                                        <input
                                            type='text'
                                            name="slogan"
                                            className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    ...
                                    <div className="col-span-4">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Property Description</label>
                                        <textarea
                                            name="description"
                                            className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    ...
                                    <div className="col-span-2">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Property Logo</label>
                                        <input
                                            type="file"
                                            name="logo"
                                    ...
                                    <div className="col-span-2">
                                        <label htmlFor="input-label" className="block text-sm font-medium mb-2">Property Image</label>
                                        <input
                                            type="file"
                                            name="images"
                                            multiple
