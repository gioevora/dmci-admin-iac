...
const QuestionTable: React.FC = () => {
    ...
    const columns = [
        ...
        { label: 'Questions', accessor: (category: Category) => category.question },
        { label: 'Answer', accessor: (category: Category) => category.answer },
        { label: 'Status', accessor: (category: Category) => category.status },
        {
            label: 'Actions',
