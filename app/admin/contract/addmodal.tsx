...
const AddModal: React.FC<AddModalProps> = ({ mutate }) => {
    ...
    return (
        <div>
            <button
                type="button"
                className="min-w-[165px] py-2 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none"
                aria-label="Add Contract"
                onClick={() => setModalOpen(true)}
            >
                <IoAddCircleOutline className="h-6 w-6" /> Add Contract
            </button>
