                ...
                <>
                    <div className="flex items-center space-x-2">
                        <Gallery withDownloadButton>
                            <Item original={`https://dmci-agent-bakit.s3.ap-southeast-1.amazonaws.com/contracts/${category.image}`} height="800" width="500">
                                {({ ref, open }) => (
                                    <img
                                        ref={ref}
                                        onClick={open}
                                        src={`https://dmci-agent-bakit.s3.ap-southeast-1.amazonaws.com/contracts/${category.image}`}
                                        alt="Product Image"
                                        className="max-h-24 object-cover cursor-pointer"
                                    />
                                )}
                            </Item>
                        </Gallery>
