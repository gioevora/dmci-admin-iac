...
const Error: React.FC<ErrorProps> = ({ message }) => {
    return (
        <div className="absolute top-4 start-1/2 -translate-x-1/2 max-w-xs bg-white border text-neutral-600 border-gray-200 rounded-xl shadow-lg z-50" role="alert" tabIndex={-1} aria-labelledby="hs-toast-error-example-label">
